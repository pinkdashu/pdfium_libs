...
/// pdfium_libs_bindings_generated
class PdfiumLibsBindings {
  /// Holds the symbol lookup function.
  final ffi.Pointer<T> Function<T extends ffi.NativeType>(String symbolName)
      _lookup;

  /// The symbols are looked up in [dynamicLibrary].
  PdfiumLibsBindings(ffi.DynamicLibrary dynamicLibrary)
      : _lookup = dynamicLibrary.lookup;

  /// The symbols are looked up with [lookup].
  PdfiumLibsBindings.fromLookup(
...
typedef TimerCallback
    = ffi.Pointer<ffi.NativeFunction<ffi.Void Function(ffi.Int idEvent)>>;
